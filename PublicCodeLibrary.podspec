#
# Be sure to run `pod spec lint PublicCodeLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of PublicCodeLibrary
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "blackjacx" => "stefan.herold@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'blackjacx', 'other author'
